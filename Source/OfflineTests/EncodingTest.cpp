...
namespace OfflineTests
{
    ...
    public:
        ...
        TEST_METHOD(cp1251_1)
        {
            ...
            const String destination = cp1251_to_unicode(source);
            Assert::AreEqual(String(L"\u0423 \u043F\u043E\u043F\u0430 \u0431\u044B\u043B\u0430 \u0441\u043E\u0431\u0430\u043A\u0430"), destination);
        }

        TEST_METHOD(cp1251_2)
        {
            const String source = L"\u0423 \u043F\u043E\u043F\u0430 \u0431\u044B\u043B\u0430 \u0441\u043E\u0431\u0430\u043A\u0430";
        ...
        TEST_METHOD(toUtf_2)
        {
            const String text = L"Hello! \u0423 \u043F\u043E\u043F\u0430 \u0431\u044B\u043B\u0430 \u0441\u043E\u0431\u0430\u043A\u0430";
            Byte buffer[1024], *ptr;
        ...
        TEST_METHOD(fromUtf_2)
        {
            ...
            Assert::AreEqual(String(L"Hello!"), result);
            end++;
            size--;
            end++;
            size--;
            fromUtf(end, size, 0x10, result);
            Assert::AreEqual(String(L"\u0423 \u043F\u043E\u043F\u0430 \u0431\u044B\u043B\u0430 \u0441\u043E\u0431\u0430\u043A\u0430"), result);
        }
    };
}
